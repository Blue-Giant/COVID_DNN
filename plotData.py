...
def plotTrain_losses(loss2act1, loss2act2, loss2act3, lossType=None, actName1=None, actName2=None, actName3=None,
...
def plot_Test_MSE_REL_3Types(mse2s2act1, mse2s2act2, mse2s2act3, rel2s2act1, rel2s2act2, rel2s2act3, actName1=None,
                             actName2=None, actName3=None, epoches=None, seedNo=1000, outPath=None):
    # fig2mse_test = plt.figure(figsize=(10, 8), dpi=98)
    fig2mse_test = plt.figure(figsize=(9, 6.5), dpi=98)
    ax = plt.gca()
    ax.plot(epoches, mse2s2act1, 'g-.', label=str('MSE-'+actName1))
    ax.plot(epoches, rel2s2act1, 'b:', label=str('REL-'+actName1))
    ax.plot(epoches, mse2s2act2, 'm--', label=str('MSE-'+actName2))
    ax.plot(epoches, rel2s2act2, 'c-*', label=str('REL-'+actName2))
    ax.plot(epoches, mse2s2act3, color='k', marker='v', label=str('MSE-'+actName3))
    ax.plot(epoches, rel2s2act3, color='gold', marker='x', label=str('REL-'+actName1))
    plt.xlabel('epoch/1000', fontsize=14)
    plt.ylabel('error', fontsize=14)
    ax.set_yscale('log')
    ax.legend(loc='center', bbox_to_anchor=(0.49, 1.06), ncol=3, fontsize=12)
